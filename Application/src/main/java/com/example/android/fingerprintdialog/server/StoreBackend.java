...
public interface StoreBackend {
     ...
     */
    boolean verify(Transaction transaction, byte[] signature);
     ...
     *
     * @param authenInfo    the unique ID of the user within the app including server side
     *                  implementation
     ...
     */
    boolean enroll(String authenInfo, PublicKey publicKey);
}
